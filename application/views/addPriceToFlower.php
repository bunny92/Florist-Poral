                                                ...
                                                foreach ($flowers as $value) {
                                                    ...
                                                    <tr class="table_details">
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <input type="text" value="0" class="form-control flower_price text-warning" name="flower_price[]" id="flower_price_<?= $value->id ?>">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
...
<script type="text/javascript">
                                        ...
                                        $(".addExpenses").addClass('active');
                                        $(".navbar-brand").append("Add Price to Flowers");
                                        ...
                                        function addPayListForm() {
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: baseurl + "supplier/ajax_addPriceList",
                                                data: data,
                                                beforeSend: function () {
                                                    $("#error").fadeOut();
