                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-md-offset-3 col-lg-offset-3 col-sm-12">
                                    <select class="selectpicker" name="supplier_id" id="customer_id" data-style="btn btn-success btn-round" title="Single Select" data-size="7">
...
<script type="text/javascript">
    ...
    $(".SViewBilling").addClass('active');
    $(".navbar-brand").append("Check Billing for Supplier");
