...
<script type="text/javascript">
    ...
    $(".editExpenses").addClass('active');
    $(".navbar-brand").append("Modify Supplier Price to Flowers");

    $.ajax({
     
        url: baseurl + "supplier/ajax_recentPriceEventList",
        method: "post",
        data: {"data": "check"},
    ...
    function updatePayListForm() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "supplier/ajax_updatePriceList",
            data: data,
            beforeSend: function () {
                $("#error").fadeOut();
                $("#advance-submit").html(
            ...
            success: function (response) {
                ...
                if ($.trim(response) === "success") {
                    ...
                    $.notify({
                        icon: "notifications",
                        title: "Success",
                        message: "Price got updated to supplier flowers"
